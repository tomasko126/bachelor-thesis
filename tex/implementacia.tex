...
Ak by sa záznamy neočistili, nebolo by možné nie len napárovať jednotlivé zvieratá a vrhy k ich majiteľom a chovateľom, ale ani importovať týchto ľudí do tabuľky \mintinline{php}{people} a napárovať ich s jednotlivými chovnými stanicami z tabuľky \mintinline{php}{stations}.
