...
V tejto prílohe sa nachádzajú snímky obrazoviek finálnej webovej aplikácie s ich popisom. Dáta, ktoré je možné vidieť na jednotlivých snímkoch, boli vytvorené PHP knižnicou \mintinline{php}{Faker}, ktorá umožňuje generovanie falošných dát so špecifikáciou ich formy. Nakoľko je webová aplikácia responzívna, na konci prílohy sa nachádzajú snímky obrazovky aplikácie pri jej mobilnom zobrazení.
